...
This repository contains the frontend application built with Vue.js/Nuxt3, while the backend API is located in the  [sierramar_api](https://github.com/juankypunk/sierramar_api) repository .
